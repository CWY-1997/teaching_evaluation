<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:100:"D:\WebSite\htdocs\teaching_evaluation\public/../application/index\view\teacher\tea-defence-list.html";i:1573801259;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td>
                <button type="button" name="myfile" class="layui-btn layui-btn-radius layui-btn-warm"  onclick="adopt(this,'<?php echo $list['defence_id']; ?>',1)">答辩通过</button>
                <button type="button" name="myfile" class="layui-btn layui-btn-radius layui-btn-danger" onclick="adopt(this,'<?php echo $list['defence_id']; ?>',2)" >答辩不通过</button>
            </td>
...
<script>
    ...
    function adopt(obj,id,type){
        ...
        layer.confirm(tis,function(index){
            ...
            $.ajax({
                type: 'POST',
                url: 'http://te.com/index/Teacher/adoptDefence',
