<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"D:\WebSite\htdocs\teaching_evaluation\public/../application/index\view\teaching\task-resources.html";i:1573916018;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    <xblock>
        <div class="layui-row">
            <div class="layui-form layui-col-md12 x-so" style="   margin-bottom: 0px;">
                <button type="button" name="myfile" class="layui-btn" >上传新的教学任务</button>
    ...
    <table class="layui-table">
        ...
        <tbody>
        <?php if(is_array($getList) || $getList instanceof \think\Collection || $getList instanceof \think\Paginator): $i = 0; $__LIST__ = $getList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;if($list['res_type'] == 1): ?>
        <tr>
            <td><?php echo $i; ?></td>
