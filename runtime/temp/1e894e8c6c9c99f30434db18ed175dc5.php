<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:101:"D:\WebSite\htdocs\teaching_evaluation\public/../application/index\view\teacher\tea-online-course.html";i:1573741877;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <?php if($vo['teaching_apply_status'] == 0): ?>
            <td><font style="color:#0b927b">已申请待审核</font></td>
            <?php endif; if($vo['teaching_apply_status'] == 1): ?>
            <td><font style="color:#0b927b">已申请通过</font></td>
            <?php endif; if($vo['teaching_apply_status'] == 2): ?>
            <td class="td-manage">
            ...
            <?php endif; if($vo['teaching_apply_status'] == 3): ?>
            <td class="td-manage">
...
<script>
    ...
    function member_add(obj,id){
        layer.confirm('确认申请课程吗？',function(index){
            ...
            $.ajax({
                type: 'POST',
                url: 'http://te.com/index/Teacher/applyCourse',
                data: {course_id:id},
                success:
                    function (stu) {
