<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"D:\WebSite\htdocs\teaching_evaluation\public/../application/index\view\student\stu-credit.html";i:1573733515;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    ...
    <table class="layui-table">
        <thead>
        <tr colspan="9" style="text-align: center;color: #1E9FFF; font-weight: bold;font-size: 16px;">
            <td colspan="9">总学分：<?php echo $sum; ?>分</td>
        </tr>
        <tr>
            <th>序号</th>
            <th>课程名称</th>
