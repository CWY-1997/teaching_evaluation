<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"D:\WebSite\htdocs\teaching_evaluation\public/../application/index\view\Login\secretary_index.html";i:1573917725;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<?php echo url('Secretary/courseInfoList'); ?>">
                            <i class="fa fa-file-text-o" aria-hidden="true"></i>
                            <cite>课程信息导入</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="<?php echo url('Secretary/upResources'); ?>">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<?php echo url('Secretary/listEvaluation'); ?>">
                            <i class="fa fa-user-md" aria-hidden="true"></i>
                            <cite>优秀学生申请</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="<?php echo url('Secretary/teaListEvaluation'); ?>">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<?php echo url('Secretary/getResources'); ?>">
                            <i class="fa fa-krw" aria-hidden="true"></i>
                            <cite>所有资源</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<?php echo url('Secretary/personalInformation'); ?>">
                            <i class="fa fa-bookmark-o" aria-hidden="true"></i>
                            <cite>基本信息</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="<?php echo url('Secretary/account'); ?>">
