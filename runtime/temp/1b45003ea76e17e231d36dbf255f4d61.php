<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:100:"D:\WebSite\htdocs\teaching_evaluation\public/../application/index\view\teacher\apply-course-stu.html";i:1573899848;}*/ ?>
<!DOCTYPE html>
<html>

<head>
    <meta charset="UTF-8">
    <title> 本课程申请学生名单</title>
...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td><?php echo $getCountInfo['course_year']; ?>年</td>
            <td><?php echo $getCountInfo['course_name']; ?></td>
            <td><?php echo $getCountInfo['course_number']; ?>人</td>
            <td>
                <button class="layui-btn layui-btn-danger" >同意加入课程</button>
                <button class="layui-btn layui-btn-danger" >不同意加入课程</button>
            </td>
        </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
        <tr colspan="8" style="text-align: center;">
            <td colspan="8">
                <button class="layui-btn layui-btn-danger" >一键同意加入</button>
            </td>
        </tr>
        </tbody>
    </table>
