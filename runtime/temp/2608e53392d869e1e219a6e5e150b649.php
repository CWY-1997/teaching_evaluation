<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:103:"D:\WebSite\htdocs\teaching_evaluation\public/../application/index\view\teacher\homework-correction.html";i:1573897733;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td>
                <button class="layui-btn layui-btn-danger" onclick="x_admin_show('作业批改','homeworkPreselection/ass_id/<?php echo $list['ass_id']; ?>',1300,800)">作业批改</button>
            </td>
