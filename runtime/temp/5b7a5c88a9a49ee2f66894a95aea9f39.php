<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"D:\WebSite\htdocs\teaching_evaluation\public/../application/index\view\teaching\tea-evaluation.html";i:1573484673;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td><a title="下载"  href="http://te.com/appraising/student/<?php echo $list['tea_excellent_path']; ?>"><font style="color: red">下载</font></a></td>
            ...
            <?php endif; ?>
            <td class="td-manage">
                <button type="button" class="layui-btn layui-btn-sm layui-btn-normal" onclick="member_del(this,'<?php echo $list['tea_excellent_id']; ?>')">审核通过</button>
                <button type="button" class="layui-btn layui-btn-sm layui-btn-danger" onclick="x_admin_show('审核学生不通过','teaNotAdoptEvaluation/id/<?php echo $list['tea_excellent_id']; ?>',500,300)">审核不通过</button>
            </td>
        </tr>
...
<script>
    ...
    function member_del(obj,id){
        layer.confirm('确认审核通过吗？',function(index){
            ...
            $.ajax({
                type: 'POST',
                url: 'http://te.com/index/Teaching/teaAdoptEvaluation',
