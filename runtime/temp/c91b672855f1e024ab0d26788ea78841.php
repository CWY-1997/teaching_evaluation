<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:100:"D:\WebSite\htdocs\teaching_evaluation\public/../application/index\view\student\stu-inspect-list.html";i:1573720527;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <th colspan="10" style="text-align: center;color:#FF692F " >选题还未通过、指导教师为：<?php echo $teaName; ?></th>
            <?php endif; if($topicInfo['topic_subject'] != ''): ?>
            <th colspan="10" style="text-align: center;color:#FF692F ">选题为：《<?php echo $topicInfo['topic_subject']; ?>》指导教师为：<?php echo $teaName; ?></th>
            <?php endif; ?>
        </tr>
        <tr>
            <th>序号</th>
        ...
        <tr>
            ...
            <td><?php echo $list['tea_id']; ?></td>
            <td><?php echo $list['inspect_name']; ?></td>
            <td><a title="下载"  href="http://te.com/inspect/<?php echo $list['inspect_path']; ?>"><font style="color: red">下载</font></a></td>
            <td><?php echo $list['inspect_remarks']; ?></td>
            ...
            <?php endif; ?>
            <td class="td-manage">
                <a title="删除" onclick="member_del(this,'<?php echo $list['inspect_id']; ?>')" href="javascript:;">
...
<script>
    ...
    layui.use('upload', function(){
        ...
        upload.render({ //允许上传的文件后缀
            elem: '#myfile'
            ,url: "<?php echo url('Student/inspectUpload'); ?>"
            ,accept: 'file' //普通文件
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            ...
            $.ajax({
                type: 'POST',
                url: 'http://te.com/index/Student/inspectDele',
                data: {inspect_id:id},
                success:
                    function (stu) {
