<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:102:"D:\WebSite\htdocs\teaching_evaluation\public/../application/index\view\teacher\course-performance.html";i:1573809685;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <?php endif; ?>
            <td>
                <button class="layui-btn layui-btn-danger" onclick="x_admin_show('编辑报名信息','preselection/course_id/<?php echo $list['course_id']; ?>',1300,800)">成绩录入</button>
            </td>
        </tr>
