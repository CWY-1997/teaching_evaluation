<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"D:\WebSite\htdocs\teaching_evaluation\public/../application/index\view\teaching\stu-evaluation.html";i:1573481504;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <?php endif; ?>
            <td class="td-manage">
                <button type="button" class="layui-btn layui-btn-sm layui-btn-normal" onclick="member_del(this,'<?php echo $list['stu_excellent_id']; ?>')">审核通过</button>
                <button type="button" class="layui-btn layui-btn-sm layui-btn-danger" onclick="x_admin_show('审核学生不通过','notAdoptEvaluation/id/<?php echo $list['stu_excellent_id']; ?>',500,300)">审核不通过</button>
            </td>
        </tr>
