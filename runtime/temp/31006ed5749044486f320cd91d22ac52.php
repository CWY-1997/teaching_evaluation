<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:98:"D:\WebSite\htdocs\teaching_evaluation\public/../application/index\view\secretary\su-resources.html";i:1573906782;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    <xblock>
        <div class="layui-row">
            <div class="layui-form layui-col-md12 x-so" style="   margin-bottom: 0px;">
                <input type="text" id="tea_idcard"  placeholder="请输入资源名称" autocomplete="off" class="layui-input">
                <button class="layui-btn"  lay-submit="" lay-filter="sreach" onclick="search()"><i class="layui-icon">&#xe615;</i></button>
                <button type="button" name="myfile" class="layui-btn" >查看公共资源</button>
                <button type="button" name="myfile" class="layui-btn" >查看教学任务</button>
                <button type="button" name="myfile" class="layui-btn" >查看培养方案</button>
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td><a title="下载"  href="http://te.com/upload/<?php echo $list['res_path']; ?>"  onclick="add(this,'<?php echo $list['res_id']; ?>')"><font style="color: red">下载</font></a></td>
